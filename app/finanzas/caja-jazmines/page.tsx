...
export default function CajaJazminePage() {
  ...
  // Si tiene valor, el modal de gasto variable abre en modo edición con ese gasto.
  const [costoAEditarVariable, setCostoAEditarVariable] = useState<GastoVariable | null>(null)
